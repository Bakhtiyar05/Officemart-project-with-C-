...
namespace OfficeMart.Domain.Migrations
{
    ...
    [Migration("20200816165559_ordernumbertableadded")]
    partial class Ordernumbertableadded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OfficeMart.Domain.Models.Entities.OrderedProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OfficeMart.Domain.Models.Entities.Order", b =>
                {
                    b.HasOne("OfficeMart.Domain.Models.Entities.OrderNumber", null)
                        .WithMany("Orders")
                        .HasForeignKey("OrderNumberId");

                    b.HasOne("OfficeMart.Domain.Models.Entities.OrderedProduct", null)
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("OfficeMart.Domain.Models.Entities.OrderedProduct", b =>
                {
                    b.HasOne("OfficeMart.Domain.Models.Entities.Order", "Order")
                        .WithMany()
