...
namespace OfficeMart.Domain.Migrations
{
    ...
    [Migration("20240514225149_Unused tables removed and migrated to new server")]
    partial class Unusedtablesremovedandmigratedtonewserver
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OfficeMart.Domain.Models.Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("RegDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified));
            ...
            modelBuilder.Entity("OfficeMart.Domain.Models.Entities.OrderNumber", b =>
                {
                    ...
                    b.ToTable("OrderNumber");
                });

            modelBuilder.Entity("OfficeMart.Domain.Models.Entities.OrderPolicy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OfficeMart.Domain.Models.Entities.RegisterPolicy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
