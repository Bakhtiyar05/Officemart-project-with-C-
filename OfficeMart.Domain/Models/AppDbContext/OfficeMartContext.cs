...
namespace OfficeMart.Domain.Models.AppDbContext
{
    public class OfficeMartContext : IdentityDbContext<AppUser>
    {
        ...
        {
            optionsBuilder.UseSqlServer("Data Source = SQL6011.site4now.net; Initial Catalog = db_a66876_officemart; User Id = db_a66876_officemart_admin; Password =R3150405");
